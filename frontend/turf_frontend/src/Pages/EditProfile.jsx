    ...
    const handleSaveChanges = async () => {
        ...
        try {
            ...
            const userUpdateResponse = await fetch(
                `${import.meta.env.VITE_API_URL}/home/update?email=${email}&username=${username}&mobileNumber=${phoneNumber}`,
                { method: "PUT" }
            );
            ...
            if (image) {
                ...
                const imageUploadResponse = await fetch(`${import.meta.env.VITE_API_URL}/home/uploadImage`, {
                    method: "POST",
                    body: formData,
                });
